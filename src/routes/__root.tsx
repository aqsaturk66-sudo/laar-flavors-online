    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="btn-base btn-outline-dark">
            Go home
          </a>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Laar Restaurant & Fast Food — Badin" },
      {
        name: "description",
        content:
          "Laar Restaurant & Fast Food, Gym Khana Badin — desi food, BBQ, biryani, Chinese, pizza, burgers and more in Badin, Sindh.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Restaurant",
          name: site.name,
          alternateName: site.secondaryIdentity,
          servesCuisine: ["Pakistani", "Desi", "BBQ", "Chinese", "Fast Food", "Pizza"],
